...
import 'package:homeservice/app/controller/add_review_controller.dart';
import 'package:homeservice/app/util/theme.dart';
import 'package:homeservice/app/widget/elevated_button.dart';
import 'package:homeservice/app/widget/star_rating.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Please rate the quality of service delivered'.tr,
                          textAlign: TextAlign.center,
                          style: const TextStyle(
                              fontSize: 16,
                              fontFamily: 'medium',
