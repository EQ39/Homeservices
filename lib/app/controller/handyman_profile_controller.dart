...
import 'package:homeservice/app/backend/model/review_model.dart';
...
class HandymanProfileController extends GetxController
  ...
  final HandymanProfileScreenParser parser;
  int selectedTab = 0;
  ...
  //   Get.toNamed(
  //     AppRouter.getFreelancerProductRoute(),
  //     arguments: [id, name],
  //   );
  // }
