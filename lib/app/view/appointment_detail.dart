      ...
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            centerTitle: true,
            title: Text(
              '${'Appointment ID'.tr} #${value.appointmentId}',
                    ...
                    children: [
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: FadeInImage(
                                    image: NetworkImage(
                                        '${Environments.apiBaseURL}storage/images/${value.appointmentDetail.freelancer?.cover.toString()}'),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      heading4(value
                                          .appointmentDetail.freelancer?.name
                                          .toString()),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            value.appointmentDetail.freelancer!
                                                .rating
                                                .toString(),
                                            style: const TextStyle(
                                                color: ThemeProvider.blackColor,
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          ...
                                          smallBoldText(value.appointmentDetail
                                              .freelancer?.email
                                              .toString()),
                                        ],
                                      ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              child: heading4('My Appointment'.tr),
                            ),
                            const Divider(
                              thickness: 2,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 4),
                                smallText(value.appointmentDetail.saveDate
                                    .toString()),
                              ],
                            ),
                            const Divider(
