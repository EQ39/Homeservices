      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: GestureDetector(
            onTap: () {
              Get.toNamed(AppRouter.getChooseLocationRoute());
            },
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                heading2('Categories'.tr),
                                MyTextButton(
                                    onPressed: () {
                                      Get.toNamed(
                                        AppRouter.getCategoryRoute(),
                                      );
                                    },
                                    text: 'See All'.tr,
                                    colors: ThemeProvider.greyColor)
                              ],
                            ),
                          ),
                          SingleChildScrollView(
                              ...
                              child: Row(
                                children: List.generate(
                                  ...
                                  (i) => GestureDetector(
                                    onTap: () {
                                      value.onCategory(
                                          value.categoryList[i].id as int,
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            child: FadeInImage(
                                              ...
                                              height: 60,
                                              image: NetworkImage(
                                                  '${Environments.apiBaseURL}storage/images/${value.categoryList[i].cover.toString()}'),
                          ...
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                heading2('Recommended'.tr),
                                MyTextButton(
                                    onPressed: () {
                                      Get.toNamed(
                                        AppRouter.getPopularRoute(),
                                      );
                                    },
                                    text: 'See All'.tr,
                                    colors: ThemeProvider.greyColor)
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  value.currencySide == 'left'
                                                      ? '${value.currencySymbol}${value.freelancerList[i].hourlyPrice}/${'day'.tr}'
                                                      : '${value.freelancerList[i].hourlyPrice}${value.currencySymbol}/${'day'.tr}',
                                                  textAlign: TextAlign.center,
                                                  style: const TextStyle(
                                                      fontFamily: 'bold',
                                                      color: ThemeProvider
                          ...
                          //           onPressed: () {
                          //             Get.toNamed(
                          //               AppRouter.getPopularProductRoute(),
                          //             );
                          //           },
                          //           text: 'See All'.tr,
                          //           colors: ThemeProvider.greyColor)
                          ...
                          //                         FadeInImage(
                          //                           image: NetworkImage(
                          //                               '${Environments.apiBaseURL}storage/images/${value.productList[i].cover.toString()}'),
                          //                           placeholder: const AssetImage(
                          //                               "assets/images/placeholder.jpeg"),
                          //                           imageErrorBuilder: (context,
                          //                               error, stackTrace) {
  ...
  squareImage(val) {
    return BoxDecoration(
        image: DecorationImage(
            image:
                NetworkImage('${Environments.apiBaseURL}storage/images/$val'),
            fit: BoxFit.cover,
